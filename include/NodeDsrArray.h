#ifndef __NODEDSRMANAGER_H_
#define __NODEDSRMANAGER_H_
...
public:
    static int32_t Set(NodeDsr *pclNodeDsr)
    {
        ...
        uint32_t nIndex;
        for (nIndex = 0; nIndex < NODEDSR_NUMBER_LIMIT; nIndex++)
        {
        ...
        if (nIndex >= NODEDSR_NUMBER_LIMIT)
            return -1;
...
public:
    static std::array<NodeDsr *, NODEDSR_NUMBER_LIMIT> sm_NodeDsrArray;
};

std::array<NodeDsr *, NODEDSR_NUMBER_LIMIT> NodeDsrArray::sm_NodeDsrArray;

#endif // __NODEDSRMANAGER_H_